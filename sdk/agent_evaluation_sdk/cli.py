    ...
    if eval_config.exists():
        ...
        try:
            ...
            if config.get("dataset", {}).get("auto_collect"):
                warnings.append("auto_collect is enabled - remember to disable after collecting data")
...
Examples:
  ...
  agent-eval-assistant validate --project ~/my-agent  # Check specific directory
    ...
    setup_parser = subparsers.add_parser(
        'setup',
        help='Get instructions to run the interactive setup assistant'
    )
    ...
    validate_parser = subparsers.add_parser(
        'validate',
        help='Validate your existing setup configuration'
    )
